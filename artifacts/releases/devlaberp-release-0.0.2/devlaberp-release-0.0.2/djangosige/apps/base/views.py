...
class IndexView(TemplateView):
    ...
    def _make_stat_card(self, title, value, subtitle, href, tone='neutral', icon='', domain='neutral', action_label='Abrir'):
        return {
            'title': title,
            'value': value,
            'subtitle': subtitle,
    ...
    def get_context_data(self, **kwargs):
        ...
        if user.has_perm('financeiro.view_lancamento'):
            alert_cards.extend([
                self._make_alert_card(
                    ...
                    action_label='Ver contas atrasadas',
                    severity='danger',
                ),
                self._make_alert_card(
                    ...
                    action_label='Ver cobrancas atrasadas',
                    severity='warning',
                ),
            ])
        ...
        if user.has_perm('cadastro.view_produto'):
            alert_cards.append(self._make_alert_card(
                ...
                action_label='Abrir estoque critico',
                severity='danger',
            ))
        ...
        if user.has_perm('vendas.view_pedidovenda'):
            alert_cards.append(self._make_alert_card(
                ...
                action_label='Ver pedidos atrasados',
                severity='warning',
            ))
        ...
        if user.has_perm('cadastro.view_fornecedor'):
            cadastro_cards.append(self._make_stat_card(
                ...
                icon='local_shipping',
                domain='purchase',
                action_label='Abrir fornecedores',
            ))
        if user.has_perm('cadastro.view_produto'):
            cadastro_cards.append(self._make_stat_card(
                title='Produtos',
        ...
        context['dashboard_financial_snapshot'] = [
            self._make_stat_card(
                ...
                icon='call_received',
                domain='finance',
                action_label='Abrir recebimentos',
            ),
            self._make_stat_card(
                title='A pagar hoje',
