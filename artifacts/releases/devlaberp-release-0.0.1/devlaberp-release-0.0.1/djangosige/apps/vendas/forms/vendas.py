...
class VendaForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        configure_remote_model_choice_field(
            self.fields['transportadora'],
            self.fields['transportadora'].queryset,
            '%s?tipo=transportadora' % reverse_lazy('cadastro:consultapessoa'),
            'Buscar transportadora por nome ou documento',
            get_selected_model_choice_value(self, 'transportadora'),
        )
...
class ItensVendaForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        configure_remote_model_choice_field(
            self.fields['produto'],
            self.fields['produto'].queryset.order_by('descricao'),
