...
class NotaFiscalSaidaForm(NotaFiscalForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        configure_remote_model_choice_field(
            self.fields['dest_saida'],
            self.fields['dest_saida'].queryset,
            '%s?tipo=cliente' % reverse_lazy('cadastro:consultapessoa'),
            'Buscar cliente por nome ou documento',
            get_selected_model_choice_value(self, 'dest_saida'),
        )
...
class NotaFiscalEntradaForm(NotaFiscalForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        configure_remote_model_choice_field(
            self.fields['emit_entrada'],
            self.fields['emit_entrada'].queryset,
            '%s?tipo=fornecedor' % reverse_lazy('cadastro:consultapessoa'),
            'Buscar fornecedor por nome ou documento',
            get_selected_model_choice_value(self, 'emit_entrada'),
        )
